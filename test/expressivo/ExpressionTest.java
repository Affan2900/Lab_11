...
public class ExpressionTest {
    ...
    // Removed testAssertionsEnabled as it's generally unnecessary for expression testing.
    ...
    public void testParseMultiply() {
        // Modified test to include more edge cases.
        ...
        e = Expression.parse("0.0 * x");
        assertEquals(new Number(0), e);

        // Edge case with zero in multiplication
        e = Expression.parse("0.0 * var");
        assertEquals(new Number(0), e);
    }
